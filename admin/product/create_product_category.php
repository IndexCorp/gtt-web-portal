...
if(isset($_GET['create-product-category'])){
   
    if(!empty($_GET['create-product-category'])){
        $id = $_GET['create-product-category'];

        $get_cat = $getFromCourse->get_single('product_category', $id);
    }
...
<div class="page__heading border-bottom">
    <div class="container-fluid page__container d-flex align-items-center">
       ...
       <p>
       <a class="btn btn-secondary btn-xs" href="admin/product-category"> Back to Category</a>
...
<div class="container-fluid page__container">
    <div class="tab-content">
        <div class="tab-pane active show fade" id="c-bio">
            <!-- FIRST TAB CONTENT -->
         <form method="post" action="admin/create-product-category" enctype="multipart/form-data">
            ...
            <div class="col">
             ...
             <div class="form-group">
                ...
                <div class="form-group">
                   <input type="submit" name="product-category_data" class="btn btn-outline-warning" value="Update Category Info.">
                </div>
                ...
                <input id="cat_type"  name="cat_type"  value="save" type="hidden" class="form-control">
                    ...
                    <div class="form-group">
                   <input type="submit" name="product-category_data" class="btn btn-outline-primary" value="Save Category Info.">
                </div>
