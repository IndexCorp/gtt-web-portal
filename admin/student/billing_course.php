        ...
        <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values="[&quot;js-lists-values-employee-name&quot;]">
            ...
            <table class="table mb-0 thead-border-top-0">
                ...
                <?php 
                    ...
                    if(isset($_GET['course_billing'])){
                        $term = $_GET['course_billing'];
                        $sn = 0;
                       // $news = $getFromCourse->get_courses_g($term);

                        $paginations = @$getFromGeneric->get_single_g('payment', 'course_id', $term);
