...
<div class="container-fluid page__container">
    ...
    <div class="card">
        ...
        <h3>Outstanding Payment List</h3><br>
        ...
        <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values="[&quot;js-lists-values-employee-name&quot;]">
            ...
            <table class="table mb-0 thead-border-top-0">
                ...
                <?php 
                    ...
                    if(isset($_GET['billing_outstanding'])){

                            $limit = 20;
                        if($_GET['billing_outstanding'] == 0){
                                $page = 1;
                            $offset = (($page - 1)* $limit );
                        }else{
                            $page = $_GET['billing_outstanding'];
                            $offset = (($page - 1)* $limit );
                        }
        ...
        <div class="ml-auto">
                            ...
                            <a href="admin/billing_outstanding/<?=$page - 1?>" class=""><i class="material-icons float-left">arrow_backward</i></a>
                            <?php }?>
                              <?php /*=$lower;?> <span class=" text-center text-black">of  <?=$uper;?></span>*/?>
                                ...
                                ?>
                                    <?php }else{
                                        ?> 
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a href="admin/billing_outstanding/<?=$page + 1?>" class=""><i class="material-icons float-right">arrow_forward</i></a>
                                        <?php }?>
