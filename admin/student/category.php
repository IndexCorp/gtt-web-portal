    ...
    <div class="card">
        ...
        <div class="card-header">
             ...
             <?php 
                ...
                <a href="admin/create_category/"  class="btn btn-outline-primary ml-auto">
                   New Category
                </a>
                </div>
                <?php } ?>
        ...
        <div class="table-responsive border-bottom" data-toggle="lists" data-lists-values="[&quot;js-lists-values-employee-name&quot;]">
            ...
            <table class="table mb-0 thead-border-top-0">
                ...
                if(isset($_GET['category'])){
                    ...
                    $cur =  $paginations =$getFromCourse->pagination_lower('course_category', $offset, $limit);

                    $lower = ($page - 1) * $limit + $cur;
                    $uper = $getFromCourse->pagination_count('course_category');


                    
                    
                    $paginations =$getFromCourse->pagination('course_category', $offset, $limit, 'cat_name');
                    $sn = 0;
                ...
                ?>
                   ...
                   <td>
                        ...
                        //  $courses = $getFromGeneric->get_singles('student_courses', $category->id);
                            //var_dump($courses);
...
*/?>
                ...
                ?>
                        <td> 
                                <a class="btn btn-light" href="admin/create_category/<?= $category->id;?>">Edit</a>
                        </td>
        ...
        <div class="ml-auto">
                            ...
                            <a href="admin/category/<?=$page - 1?>" class=""><i class="material-icons float-left">arrow_backward</i></a>
                            <?php }?>
