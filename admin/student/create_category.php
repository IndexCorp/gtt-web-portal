...
if(isset($_GET['create_category'])){
    ...
    if(!empty($_GET['create_category'])){
        $id = $_GET['create_category'];

        $get_cat = $getFromCourse->get_single('course_category', $id);
    }
...
<div class="page__heading border-bottom">
    <div class="container-fluid page__container d-flex align-items-center">
        <h1 class="mb-0">Category Menu</h1><br>
        <a class="btn btn-secondary" href="admin/catgory/"> Back to Category</a>
         ...
         <form method="post" action="admin/create_category" enctype="multipart/form-data">
            ...
            <div class="col">
             ...
             <div class="form-group">
                ...
                <div class="form-group">
                   <input type="submit" name="category_data" class="btn btn-outline-warning" value="Update Category Info.">
                </div>
                ...
                <input id="cat_type"  name="cat_type"  value="save" type="hidden" class="form-control">
                    ...
                    <div class="form-group">
                   <input type="submit" name="category_data" class="btn btn-outline-primary" value="Save Category Info.">
                </div>
