<?php
 ...
 <?php
    ...
    if(isset($_GET['res_id'])){
       ...
       $res_id = $_GET['res_id'];
        $result_details= $getFromExam->get_single('diploma_result', $res_id);
        ...
        <div class="tab-pane active show fade" id="c-basic">
           <!-- SECOND TAB CONTENT -->
            ...
            <div class="col-md">
                ...
                ?>
                     <form method="post" action="admin/student/result_upload_dip.php?res_id=<?=@$res_id?>" enctype="multipart/form-data">
                           
                <?php }else{?>
                    <form method="post" action="admin/student/result_upload_dip.php?std=<?=@$student_id?>&course_id=<?=@$course_id?>" enctype="multipart/form-data">
                ...
                <?php }?>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h3 for="select01">Module 1</h3><br>
                                </div>
                                <div class=" col-4 form-group dropzone" data-select2-id="18" action="/file-upload">
                                    <label for="select01">Score </label>
                                                
                                   
                                         <input type="text"   name="module_1"  value="<?=@$result_details->module_1?>" class="form-control">
                                    ...
                                    <?php /*     <div class=" col-4 form-group dropzone" >
                      ...
                      <form method="post" action="admin/student/result_upload_dip.php?std=<?=@student_id?>" enctype="multipart/form-data">
                         ...
                         <div class="row">
                             ...
                             <div class=" col-4 form-group dropzone" >
                                 <label for="country"><strong>Total</strong></label><br>
                         ...
                         <div class="row">
                             <div class="col-12">
                                 <h3 for="select01">Final Exam </h3><br>
                             </div>
                             <div class=" col-4 form-group dropzone" data-select2-id="18" action="/file-upload">
                                 <label for="select01">Score </label>
                             ...
                             <div class=" col-4 form-group dropzone" >
                                 ...
                                 <select id="select01" name="module_f_grade" data-toggle="select"  class="form-control select2-hidden-accessible" data-select2-id="select01" tabindex="-1" aria-hidden="true">
                                     ...
                                     ?>   
                                     <option value="<?=$result_details->final_grade?>" ><?=$result_details->final_grade?></option>
    ...
    if(isset($_POST['update_module_1'])){
      ...
      //  $module_grade = $_POST['module_1_grade'];
                  ...
                  if(isset($_POST['res_id'])){
                    ...
                    $up_doc =  $getFromExam->update('diploma_result', $res_id, array('student_id'=>$student_id, 'course_id'=>$course_id,'module_1'=>$module));
                   
                 }else{
                   $up_doc =  $getFromExam->create('diploma_result', array('student_id'=>$student_id, 'course_id'=>$course_id,'module_1'=>$module));
                   $res_id = $up_doc;
      ...
      setInterval(() => {
        window.open('admin/student/result_upload_dip.php?res_id=".$res_id."','_self');
      }, 2000); 
    ...
    if(isset($_POST['update_module_3'])){
            ...
            // $module_3_grade = $_POST['module_3_grade'];
                  ...
                  if(isset($_POST['res_id'])){
                    ...
                    $up_doc =  $getFromExam->update('diploma_result', $res_id, array('student_id'=>$student_id, 'course_id'=>$course_id,'module_3'=>$module_3));
                   
                 }else{
                   $up_doc =  $getFromExam->create('diploma_result', array('student_id'=>$student_id, 'course_id'=>$course_id,'module_3'=>$module_3));
                   $res_id = $up_doc;
    ...
    if(isset($_POST['update_module_2'])){
        ...
        //$module_2_grade = $_POST['module_2_grade'];
                  ...
                  if(isset($_POST['res_id'])){
                    ...
                    $up_doc =  $getFromExam->update('diploma_result', $res_id, array('student_id'=>$student_id, 'course_id'=>$course_id,'module_2'=>$module_2));
                   
                 }else{
                   $up_doc =  $getFromExam->create('diploma_result', array('student_id'=>$student_id, 'course_id'=>$course_id,'module_2'=>$module_2));
                   $res_id = $up_doc;
    ...
    if(isset($_POST['update_module_f'])){
        ...
        $module_f_grade = $_POST['module_f_grade'];
                  ...
                  if(isset($_POST['res_id'])){
                    ...
                    $up_doc =  $getFromExam->update('diploma_result', $res_id, array('student_id'=>$student_id, 'course_id'=>$course_id,'final'=>$module_f, 'final_grade'=>$module_f_grade));
                   
                 }else{
                   $up_doc =  $getFromExam->create('diploma_result', array('student_id'=>$student_id, 'course_id'=>$course_id,'final'=>$module_f, 'final_grade'=>$module_f_grade));
                   $res_id = $up_doc;
