...
if(isset($_GET['student_school'])){
    $url_d = $_GET['student_school'];
$school_det = $getFromGeneric->get_single('school', $url_d);
...
<div class="page__heading">
    <div class="container-fluid page__container">
        <h1 class="mb-0">Student in <strong class="text-danger"><?=$school_det->school_name;?></strong></h1>
        <a href="admin/student/" class="badge badge-dark-gray text-white">Back to Student</a>
    </div>
</div>
...
<?php 
                ...
                if(isset($_GET['student_search'])){
                    $term = $_GET['student_search'];
                    $sn = 0;
                    $news = $getFromAdmin->get_students_by_school($school_id);
                  //  var_dump($news);
                    foreach($news as $new):
                        $student = $getFromGeneric->get_single('user', $new->student_id);
                        $sn +=1;
                ?>
...
<tr >
<td colspan="5"><h1 class="text-primary text-center">Above is the Search Result</h1></td>
</tr>
