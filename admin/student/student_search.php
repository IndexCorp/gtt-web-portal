...
<?php 
                ...
                if(isset($_GET['student_search'])){
                    ...
                    $sn = 0;
                    $news = $getFromAdmin->get_students($term);
                  //  var_dump($news);
                    foreach($news as $student):
                        $sn +=1;
                ?>
...
<tr class="selected" >
                ...
                ?>
                        ...
                        <form method="POST" action="admin/student/">
                        <input type="hidden" name="student_id"  value="<?= $student->id;?>">
                           <button name="delete_student" type="submit" class="btn btn-outline-danger">Delete</a>
                    </form>    
