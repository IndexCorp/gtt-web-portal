						...
						<div class="row">	
							<div class="col-md-12">
								<div class="hero-txt white-color">
									...
									<!-- Title -->
									<h3 class="h3-xs">All <?=@$getFromGeneric->get_single('course_category', $cat_id)->cat_name;?> Course</h3>
				...
				<section id="courses-5" class="courses-section division">
					<div class="container">
						...
						<?php 
								...
								$courses =$getFromCourse->get_single_g('courses', 'cat_id',$cat_id );
								if(!empty($courses)){
