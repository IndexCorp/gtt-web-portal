                                ...
                                <div class="app-chat-container">
                                    <div class="row h-100 m-0">
                                        <div class="col-lg-12 py-3 d-flex flex-column h-100">
                                            ...
                                            <form method="post" action="student/chat/">
                                                ...
                                                <div class="input-group-append">
                                                    ...
                                                    <div class="input-group-text pl-0">
                                                        <div class="custom-file custom-file-naked d-flex">
                                                            <input type="submit" name="sumbit_student_chat" class="custom-file-input" id="customFile">
                                                    ...
                                                    <div class="media border-bottom py-3">
                                                        ...
                                                        <div class="media-body">
                                                            <div class="d-flex align-items-center">
                                                                <div class="flex">
                                                                    <a href="#" class="text-body bold"><?=$fname.' '.$sname;?></a>
                                                                </div>
