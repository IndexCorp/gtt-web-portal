...
<!-- Mirrored from educate.frontted.com/student-dashboard.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 13 Jan 2021 14:34:19 GMT -->
<head>
<base href="<?=BASE_URL?>">
    <meta charset="utf-8">
                    ...
                    <div class="mdk-header__content">
                        ...
                        <div class="navbar navbar-expand-sm navbar-main navbar-dark bg-primary pl-md-0 pr-0" id="navbar" data-primary>
                            <div class="container-fluid page__container pr-0">
                                ...
                                <div class="dropdown">
                                    <a href="student/student-dashboard/" data-toggle="dropdown" data-caret="false" class="dropdown-toggle navbar-toggler navbar-toggler-dashboard border-left d-flex align-items-center ml-navbar">
                                    ...
                                    <div id="company_menu" class="dropdown-menu dropdown-menu-right navbar-company-menu">
                                        <div class="dropdown-item d-flex align-items-center py-2 navbar-company-info py-3">
                                            ...
                                            <span class="flex d-flex flex-column">
                                                <strong class="h5 m-0"><?=$fname.' '.$sname?>.</strong>
                                                <small class="text-muted text-uppercase">STUDENT</small>
                                            </span>

                                        </div>
                                        <div class="dropdown-divider"></div>
                                        <a class="dropdown-item d-flex align-items-center py-2" href="student/edit-account/">
                                            <span class="material-icons mr-2">account_circle</span> Edit Account
                                        </a>
                                        <a class="dropdown-item d-flex align-items-center py-2" href="student/edit-account/">
                                            <span class="material-icons mr-2">settings</span> Settings
                                        </a>
                                        <a class="dropdown-item d-flex align-items-center py-2" href="student/logout/">
