...
if(isset($_POST['exam_id'])){
    ...
    foreach($get_nav as $nav){
        ...
        <a href=""  class=" nav_plane list-group-item '.$color.'  '.$active.'"    my_question="'.$get_nav_question->id.'">
            <span class="media align-items-center">
                <span class="media-left mr-2">
                    <span class="btn btn-light btn-sm">#'.$count_nav.'</span>
                </span>
                <span class="media-body">
                    '.$get_nav_question->question.'
                </span>
            </span>
        </a>
        ';
       ...
       $htmlh= '
           <div class="media align-items-center">
               <div class="media-left">
                   <h4 class="m-0 text-primary mr-2"><strong></strong></h4>
               </div>
