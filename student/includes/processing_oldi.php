...
if(isset($_POST['exam_id'])){
    ...
    foreach($get_nav as $nav){
        ...
        <a href="" id="nav_plane_btn" style="margin: 3px; width:55px; height: 30px;"  class=" nav_plane_btn btn '.$color.'"    my_question="'.$get_nav_question->id.'">
                 '.$count_nav.'
       ...
       $htmlh= '
           <div class="media align-items-center">
               <div class="media-left">
                   <h4 class="m-0  mr-2"><strong id="numbering_id">1.</strong></h4>
               </div>
