            ...
            <div class="mdk-drawer__content">
                <div class="sidebar sidebar-dark sidebar-left bg-dark-gray" data-perfect-scrollbar>
                    ...
                    <div class="d-flex align-items-center sidebar-p-a sidebar-account flex-shrink-0">
                        <a href="student/" class="flex d-flex align-items-center text-underline-0">
                            <span class="mr-3">
                                <!-- LOGO -->
                            ...
                            <span class="flex d-flex flex-column">
                                <span class="sidebar-brand">Global Trade Tutor</span>
                    ...
                    <ul class="sidebar-menu">
                        <li class="sidebar-menu-item">
                            <a class="sidebar-menu-button" href="student/student-dashboard">
                    ...
                    <div class="sidebar-block p-0">
                        <ul class="sidebar-menu mt-0">
                            <li class="sidebar-menu-item <?=@$student_dashboard;?>">
                                <a class="sidebar-menu-button" href="student/student-dashboard/">
                                    <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">star_half</i>
                                    <span class="sidebar-menu-text">Dashboard</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?=@$my_course;?>">
                                <a class="sidebar-menu-button" href="student/my_courses/">
                                    <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">queue_play_next</i>
                                    <span class="sidebar-menu-text">My Courses</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?=@$student_courses;?>">
                                <a class="sidebar-menu-button" href="student/student_courses/">
                                    <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">shopping_cart</i>
                                    <span class="sidebar-menu-text">Subscribe to Courses</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?=@$assignment;?>">
                                <a class="sidebar-menu-button" href="student/assignment/">
                                    <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">live_help</i>
                                    <span class="sidebar-menu-text">Assignments</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?=@$schedule_exam;?>">
                                <a class="sidebar-menu-button" href="student/schedule_exam/">
                                    <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">testing</i>
                                    <span class="sidebar-menu-text">Schedule Final Exam</span>
                                </a>
                            </li>
                          
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="student/quiz_menu/">
                           
                                    <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">live_help</i>
                                    <span class="sidebar-menu-text">Mock Exams</span>
                                </a>
                            </li>

                            <li class="sidebar-menu-item <?=@$quiz_menu;?>">
                                <a class="sidebar-menu-button" href="student/result/">
                           
                                    <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">live_help</i>
                                    <span class="sidebar-menu-text">Results Home</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?=@$chat;?>">
                              <a class="sidebar-menu-button" href="student/message/">
                                    <i class="sidebar-menu-icon sidebar-menu-icon--left material-icons">forum</i>
                                    <span class="sidebar-menu-text">Discussions</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item <?=@$edit_account;?>">
                                <a class="sidebar-menu-button" href="student/edit-account/">
                            ...
                            <li class="sidebar-menu-item">
                                <a class="sidebar-menu-button" href="student/logout/">
