    ...
    <div class="container-fluid page__container">
      ...
      <div class="d-flex">
        ...
        <?php 
            ...
            if(isset($_GET['search_courses-stu'])){
                $term = $_GET['search_courses-stu'];
             
                $news = $getFromCourse->search_course_stud($std_id, $term);
                   // var_dump($news);
                ...
                <div class="card card__course">
                    <div class="card-header card-header-large card-header-dark bg-dark d-flex justify-content-center">
                        <a class="card-header__title  justify-content-center align-self-center d-flex flex-column" href="student/start_course/<?=$getFromCourse->get_single('courses', $datas->course_id)->id;?>">
                            <span><img src="<?=BASE_URL?>/admin/<?=$getFromCourse->get_single('courses', $datas->course_id)->img_preview;?>" class="mb-1" style="width:100%; height: auto;" alt="logo"></span>
                        </a>
                    </div>
                    <div class="p-3">
