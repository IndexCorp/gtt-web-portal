                    ...
                    <div class="d-flex">
                        ...
                        <?php 
                            ...
                            if(isset($_GET['student_courses'])){
                                   ...
                                   $cur =  $paginations =$getFromCourse->pagination_lower_course('courses', $offset, $limit);

                                   $lower = ($page - 1) * $limit + $cur;
                                   $uper = $getFromCourse->pagination_count_course('courses');


                                  
                                  
                                $paginations =$getFromCourse->pagination_course('courses', $offset, $limit);
                                ...
                                <div class="card card__course">
                                    ...
                                    <div class="p-3">
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            <a href="student/subscribe/<?=$data->id;?>" class="btn btn-primary ml-auto"><i class="material-icons">add_shopping_cart</i></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <?php }?>
                              <?=$lower;?> <span class=" text-center text-black">of  <?=$uper;?></span>
                                ...
                                ?>
                                    <?php }else{
                                        ?> 
                                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;  <a href="student/student_courses/<?=$page + 1?>" class=""><i class="material-icons float-right">arrow_forward</i></a>
                                        <?php }?>
                            </div>
                        </div>
